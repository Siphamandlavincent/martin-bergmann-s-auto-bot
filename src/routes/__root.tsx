  ...
  head: () => ({
    meta: [
      ...
      { title: "Martin Bergmann | Car Parts & Electrical Diagnostics" },
      {
        name: "description",
        content:
          "Martin Bergmann Electrical Diagnostics and Car Parts — shop car parts online and order in chat.",
      },
      { name: "author", content: "Martin Bergmann" },
      { property: "og:title", content: "Martin Bergmann | Car Parts & Electrical Diagnostics" },
      {
        property: "og:description",
        content: "Quality car parts and expert auto electrical diagnostics.",
      },
